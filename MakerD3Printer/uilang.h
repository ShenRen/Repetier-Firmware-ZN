...
#define UI_TEXT_ON               "\x7f"							//开On "On"
#define UI_TEXT_OFF              "\x80" 						//关Off "Off"
#define UI_TEXT_NA               "\x81" 						//无 "N/A" // Output for not available
#define UI_TEXT_YES              "\x82" 						//是 "Yes"
#define UI_TEXT_NO               "\x83" 						//否 "No"
#define UI_TEXT_SEL              "\003"
#define UI_TEXT_NOSEL            "\004"
#define UI_TEXT_PRINT_POS        "\x84\x85..."   				//打印"Printing..." 
#define UI_TEXT_PRINTING         "\x84\x85\x86" 				//打印中"Printing"
#define UI_TEXT_IDLE             "\x87\x88" 					//空闲"Idle"
#define UI_TEXT_NOSDCARD         "\x81 SD \x89" 				// 无SD卡"No SD Card"
#define UI_TEXT_ERROR            "**** \x8a\x8b ****" 			// 错误"**** ERROR ****"
#define UI_TEXT_BACK             "\x8c\x8d \001" 				// 返回"Back \001"
#define UI_TEXT_QUICK_SETTINGS   "\x8e\x8f\x90\x91" 			//快速设置"Quick Settings"
#define UI_TEXT_CONFIGURATION    "\x92\x91" 					//配置"Configuration"
#define UI_TEXT_POSITION         "\x93\x91" 					//位置"Position"
#define UI_TEXT_EXTRUDER         "\x94\x95\xcb" 				//挤出机"Extruder"
#define UI_TEXT_SD_CARD          "SD \x89" 						//SD 卡"SD Card"
#define UI_TEXT_DEBUGGING        "\x96\x97"						//调试"Debugging"
#define UI_TEXT_HOME_DELTA       "\xa0\x93 Delta"				//"Home Delta"
#define UI_TEXT_HOME_ALL         "\xa0\x93"						//归位"Home All"
#define UI_TEXT_HOME_X           "X \xa0\x93"					//"Home X"
#define UI_TEXT_HOME_Y           "Y \xa0\x93"					//"Home Y"
#define UI_TEXT_HOME_Z           "Z \xa0\x93"					//"Home Z"
#define UI_TEXT_PREHEAT_PLA      "\x98\x99 PLA" 				//预热PLA"Preheat PLA"
#define UI_TEXT_PREHEAT_ABS      "\x98\x99 ABS" 				//预热ABS"Preheat ABS"
#define UI_TEXT_LIGHTS_ONOFF     "\xfb\xfc :%lo"				//灯光"Lights :%lo"
#define UI_TEXT_COOLDOWN         "\x9a\x9b" 					// 降温"Cooldown"
#define UI_TEXT_SET_TO_ORIGIN    "\x90\x9c\x9d\x9e" 			//设定原点"Set to Origin"
#define UI_TEXT_DISABLE_STEPPER  "\x80\x9f\xc0\xc1\xca\xcb" 	//关闭步进电机"Disable stepper"
#define UI_TEXT_X_POSITION       "X \x93\x91"					//X位置"X Position"
#define UI_TEXT_X_POS_FAST       "X \x93\x91(\x8e\x8f)"			//X位置（快速）"X Pos. Fast"
...
#define UI_TEXT_BED_TEMP         "\x99\xc4\x9b\xc5: %Eb\002C" 	// 热床温度 "Bed temp: %Eb\002C"
#define UI_TEXT_EXTR0_TEMP       "\x9b\xc5 1:  %E0\002C"		//温度 1"Temp. 1:  %E0\002C"			//
#define UI_TEXT_EXTR1_TEMP       "\x9b\xc5 2:  %E1\002C"		//"Temp. 2:  %E1\002C"
#define UI_TEXT_EXTR2_TEMP       "\x9b\xc5 3:  %E2\002C"		//"Temp. 2:  %E2\002C"
#define UI_TEXT_EXTR0_OFF        "\x94\x95\xcb 1 \x80\x9f"		//挤出机 1 关闭"Extruder 1 Off"				//
...
#define UI_TEXT_EXTR0_SELECT     "%X0 \xa1\xa2\x94\x95\xcb 1"	//选择挤出机 1"%X0 Select Extr. 1"
...
#define UI_TEXT_EXTR_ORIGIN      "\x90\x91\x9d\x9e"				//设置原点"Set Origin"
#define UI_TEXT_PRINT_X          "\x84\x85 X:%ax"				//打印 X"Print X:%ax"
...
#define UI_TEXT_MOVE_X           "\xa4\xc3 X:%aX"				//移动 X"Move X:%aX"
...
#define UI_TEXT_JERK             "\xa5\xc3:%aj"					//抖动"Jerk:%aj"
#define UI_TEXT_ZJERK            "Z-\xa5\xc3:%aJ"				//"Z-Jerk:%aJ"
#define UI_TEXT_ACCELERATION     "\xa3\x8f"						//加速"Acceleration"
#define UI_TEXT_STORE_TO_EEPROM  "\xa6\xa8 EEPROM"              //存入eeprom"Store to EEPROM"
#define UI_TEXT_LOAD_EEPROM      "\xaa\xa8 EEPROM"              //载入eeprom"Load f. EEPROM"
#define UI_TEXT_DBG_ECHO         "\xab\xac   :%do"              //显示"Echo   :%do"
#define UI_TEXT_DBG_INFO         "\xad\xae   :%di"              //信息"Info   :%di"
#define UI_TEXT_DBG_ERROR        "\x8a\x8b   :%de"              //"Errors :%de"
#define UI_TEXT_DBG_DRYRUN       "\x97\xf0\xde:%dd"             //试一下"Dry run:%dd"
#define UI_TEXT_OPS_OFF          "%O0 OPS \x80\x9f"             //ops 关闭"%O0 OPS Off"
#define UI_TEXT_OPS_CLASSIC      "%O1 OPS \xe5\xe7"             //ops 常用"%O1 OPS Classic"
#define UI_TEXT_OPS_FAST         "%O2 OPS \x8e\x8f"             //"%O2 OPS Fast"
#define UI_TEXT_OPS_RETRACT      "\x8d\xaf :%Or"                //回抽"Retract :%Or"
...
#define UI_TEXT_ANTI_OOZE        "\xcd\xb1\xaf\xce"             //防止抽丝"Anti Ooze"
#define UI_TEXT_PRINT_FILE       "\x84\x85\xcf\xd0"             //打印文档"Print file"
#define UI_TEXT_PAUSE_PRINT      "\xd1\xb0\x84\x85"             //暂停打印"Pause Print"
#define UI_TEXT_CONTINUE_PRINT   "\xd2\xd3\x84\x85"             //继续打印"Continue Print"
#define UI_TEXT_UNMOUNT_CARD     "\xd4\xaa\xa6\xa7\x89"         //卸载存储卡"Unmount Card"
#define UI_TEXT_MOUNT_CARD       "\xa3\xaa\xa6\xa7\x89"         //加载存储卡"Mount Card"
#define UI_TEXT_DELETE_FILE      "\xa4\xd5\xcf\xd0"             //移除文件"Delete file"
#define UI_TEXT_FEEDRATE         "\x8f\xd6"                     //速率"Feedrate"
#define UI_TEXT_FEED_MAX_X       "\xd7\xd8 X:%fx"               //最大 X"Max X:%fx"
...
#define UI_TEXT_FEED_HOME_X      "\xa0\x93 X:%fX"               //归位 X"Home X:%fX"
...
#define UI_TEXT_ACTION_XPOSITION4 "X:%x0 mm","\xd7\xd9\xf1\x93:%sx","\xd7\xd8\xf1\x93:%sX",""           //最小限位，最大限位"X:%x0 mm","Min endstop:%sx","Max endstop:%sX",""
...
#define UI_TEXT_ACTION_XPOSITION_FAST2 "X:%x0 mm","\xd7\xd9:%sx \xd7\xd8:%sX"							//最小：最大"X:%x0 mm","Min:%sx Max:%sX"
...
#define UI_TEXT_FANSPEED          "\xc6\xc7\x8f\xc5" 					//风扇速度Fan speed "Fan speed"
#define UI_TEXT_ACTION_FANSPEED   "\xc6\xc7\x8f\xc5:%Fs%%%"				//风扇速度"Fan speed:%Fs%%%"
#define UI_TEXT_FAN_OFF           "\x80\x9f\xc6\xc7"					//关闭风扇"Turn Fan Off"	
#define UI_TEXT_FAN_25            "\x90\x91\xc6\xc7: 25%%%" 			//设置风扇Set Fan 25%%%"
#define UI_TEXT_FAN_50            "\x90\x91\xc6\xc7: 50%%%"				//设置风扇"Set Fan 50%%%"
#define UI_TEXT_FAN_75            "\x90\x91\xc6\xc7: 75%%%"				//设置风扇"Set Fan 75%%%"
#define UI_TEXT_FAN_FULL          "\x90\x91\xc6\xc7: 100%%%"			//设置风扇:100%"Set Fan Full"
#define UI_TEXT_STEPPER_INACTIVE  "\x80\x9f\xc0\xc1\xca\xcb"			//关闭步进电机"Stepper Inactive"
#define UI_TEXT_STEPPER_INACTIVE2 "\xf4\xe3\x80\x9f\xc0\xc1\xca\xcb:%is","[s] 0=\x80\x9f"	//延时关闭步进电机"Dis. After:%is","[s] 0=Off"
#define UI_TEXT_POWER_INACTIVE    "\x80\x9f\xca\xe6"										//关闭电源"Max. Inactive"
#define UI_TEXT_POWER_INACTIVE2   "\xf4\xe3\x80\x9f\xca\xe6:%ip","[s] 0=\x80\x9f"			//"Dis. After:%ip","[s] 0=Off"
#define UI_TEXT_GENERAL           "\xe5\xe7"												//常用"General"
#define UI_TEXT_BAUDRATE          "\xed\xee\xd6:%oc"					//比特率"Baudrate:%oc"
#define UI_TEXT_EXTR_STEPS        "\xc0\xc1/MM:%Se"						//步进/MM"Steps/MM:%Se"
#define UI_TEXT_EXTR_START_FEED   "\x7f\xda\x8f\xd6:%Xf"				//开始速率"Start FR:%Xf"
#define UI_TEXT_EXTR_MAX_FEED     "\xd7\xd9\x8f\xd6:%XF"				//最大速率"Max FR:%XF"
#define UI_TEXT_EXTR_ACCEL        "\xa3\x8f:%XA"						//加速"Accel:%XA"
#define UI_TEXT_EXTR_WATCH        "Stab.Time:%Xw"
#define UI_TEXT_EXTR_ADVANCE_L    "Advance lin:%Xl"
#define UI_TEXT_EXTR_ADVANCE_K    "Advance quad:%Xa"
#define UI_TEXT_EXTR_MANAGER      "\xdb\xdc:%Xh"						//控制"Control:%Xh"							
#define UI_TEXT_EXTR_PGAIN        "PID P:%Xp"
#define UI_TEXT_EXTR_DEADTIME     "Deadtime:%Xp"
#define UI_TEXT_EXTR_DMAX_DT      "Control PWM:%XM"
#define UI_TEXT_EXTR_IGAIN        "PID I:%Xi"
#define UI_TEXT_EXTR_DGAIN        "PID D:%Xd"
#define UI_TEXT_EXTR_DMIN         "\xd7\xd9\xc2\xc3:%Xm"				//最小驱动"Drive Min:%Xm"
#define UI_TEXT_EXTR_DMAX         "\xd7\xd8\xc2\xc3:%XM"				//最大驱动"Drive Max:%XM"
#define UI_TEXT_EXTR_PMAX         "\xd7\xd8 PID:%XD"					//最大PID"PID Max:%XD"
#define UI_TEXT_EXTR_XOFF         "X-\x93\xa4:%Xx" 						//位移"X-Offset:%Xx"
#define UI_TEXT_EXTR_YOFF         "Y-\x93\xa4:%Xy" 						//位移"Y-Offset:%Xy"
#define UI_TEXT_STRING_HM_BANGBANG "BangBang"
#define UI_TEXT_STRING_HM_PID     "PID"
#define UI_TEXT_STRING_ACTION     "xc3\xfe:%la"												//动作"Action:%la"
#define UI_TEXT_HEATING_EXTRUDER  "\x94\x95\xcb\xa3\x99\x86"								//挤出机热中"Heating Extruder"
#define UI_TEXT_HEATING_BED       "\x99\xc4\xa3\x99\x86"									//热床加热中"Heating Bed"
#define UI_TEXT_KILLED            "Killed"									//杀死 "Killed"
#define UI_TEXT_STEPPER_DISABLED  "\xc0\xc1\xca\xcb\xcc\x80\x9f" 							//步进电机已关闭"Stepper Disabled"
#define UI_TEXT_EEPROM_STORED     "\x92\x91","\xcc\xa6\xa8 EEPROM"							//配置,已存入eeprom"Configuration","stored in EEPROM"
#define UI_TEXT_EEPROM_LOADED     "\x92\x91","\xcc\xaa\xa8 EEPROM"							//配置,已载入eeprom"Configuration","loaded f. EEPROM"
#define UI_TEXT_UPLOADING         "\xdd\xdf..."												//上传"Uploading..."
...
#define UI_TEXT_PAGE_EXTRUDER3     "E3:%e2/%E2\002C\176%o2"
#define UI_TEXT_PAGE_BED          " B:%eb/%Eb\002C\176%ob"
#define UI_TEXT_SPEED_MULTIPLY    "\x8f\xd6:%om%%%"							// 速率"Speed Mul.:%om%%%"
#define UI_TEXT_FLOW_MULTIPLY     "\xe1\xe2:%of%%%" 						// 流量Flow Mul.:%of%%%"
#define UI_TEXT_SHOW_MEASUREMENT  "Show meas."
#define UI_TEXT_RESET_MEASUREMENT "Reset meas."
#define UI_TEXT_SET_MEASURED_ORIGIN "Set Z=0"
#define UI_TEXT_ZCALIB             "Z \xf5\xc8"								//z较准"Z Calib."	
#define UI_TEXT_SET_P1            "\x90\x91\xf5\xc8\x9e P1"					//设置较准点"Set P1"
#define UI_TEXT_SET_P2            "\x90\x91\xf5\xc8\x9e P2"					//"Set P2"
#define UI_TEXT_SET_P3	          "\x90\x91\xf5\xc8\x9e P3"					//"Set P3"
#define UI_TEXT_CALCULATE_LEVELING "\xf9\xfa\xf5\xc8"						//水平较准"Calculate Leveling"
#define UI_TEXT_LEVEL             "Delta \xf9\xfa\xf5\xc8"					//delta水平较准	"Level delta"
#define UI_TEXT_EXTR_WAIT_RETRACT_TEMP  "\xe9\xea\xa3\x99:%XT\002C"			// 等待加热"Wait Temp.%XT\002C"
#define UI_TEXT_EXTR_WAIT_RETRACT_UNITS "\xe9\xea\x8d\xaf:%XUmm"			// 等待回抽"Wait Units:%XUmm"
#define UI_TEXT_SD_REMOVED       "SD Card removed"							//sd卡移除"SD Card removed"
#define UI_TEXT_SD_INSERTED      "SD Card inserted"							//插入"SD Card inserted" 
#define UI_TEXT_PRINTER_READY    "Printer ready." 						//准备打印 "Printer ready."
// Printtime output gets aggregated like <Days_5gisgits>UI_TEXT_PRINTTIME_DAYS<Hours>UI_TEXT_PRINTTIME_HOURS<Minutes>UI_TEXT_PRINTTIME_MINUTES
// ___88 days 12:45
#define UI_TEXT_PRINTTIME_DAYS   " \xe8 "									//天" days "
#define UI_TEXT_PRINTTIME_HOURS  ":"
#define UI_TEXT_PRINTTIME_MINUTES ""
#define UI_TEXT_PRINT_TIME     "\x84\x85\xe3\xe4"							//打印时间"Printing time"
#define UI_TEXT_PRINT_FILAMENT "\xcc\xe7\x84\x85\xce"						//已用打印丝"Filament printed" 
#define UI_TEXT_PRINTED           "printed"
#define UI_TEXT_POWER            "ATX \xca\xe6\x7f/\x80" 					//电源开关"ATX power on/off"
#define UI_TEXT_STRING_HM_DEADTIME     "Dead Time"
#define UI_TEXT_STRING_HM_SLOWBANG     "SlowBang"
#define UI_TEXT_STOP_PRINT "\xb0\xb1\x84\x85"								// 停止打印"Stop Print"
#define UI_TEXT_Z_BABYSTEPPING "Z Babystep.:%oYmm"
#define UI_TEXT_CHANGE_FILAMENT "Change filament"
#define UI_TEXT_WIZ_CH_FILAMENT1 "Change filament"
#define UI_TEXT_WIZ_CH_FILAMENT2 "Rotate to move"
